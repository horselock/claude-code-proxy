Just a little goodie folder if you don't already have your own jailbroken setup. Pyrite.json is essentially the same setup as if you hit the v1/pyrite endpoint on this server.
